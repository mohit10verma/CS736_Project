...
#include "../../libfiber-master/include/fiber.h"
#include "../../libfiber-master/include/fiber_mutex.h"
#include "../../libfiber-master/include/fiber_cond.h"
...
#define x264_pthread_t               fiber_t
#define x264_pthread_create          fiber_create
#define x264_pthread_join            fiber_join
#define x264_pthread_mutex_t         fiber_mutex_t
#define x264_pthread_mutex_init      fiber_mutex_init
#define x264_pthread_mutex_destroy   fiber_mutex_destroy
#define x264_pthread_mutex_lock      fiber_mutex_lock
#define x264_pthread_mutex_unlock    fiber_mutex_unlock
#define x264_pthread_cond_t          fiber_cond_t
#define x264_pthread_cond_init       fiber_cond_init
#define x264_pthread_cond_destroy    fiber_cond_destroy
#define x264_pthread_cond_broadcast  fiber_cond_broadcast
#define x264_pthread_cond_wait       fiber_cond_wait
#else
